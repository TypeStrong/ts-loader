...
### Using files generated by previous loaders

It is possible to generate files in previous loaders to be used by ts-loader.

This is used by [ts-css-loader](https://github.com/MortenHoustonLudvigsen/ts-css-loader) to provide typings for css modules generated using [css-loader](https://github.com/webpack-contrib/css-loader), and by [ts-json-loader](https://github.com/MortenHoustonLudvigsen/ts-json-loader) to provide typings for json files.

To write a loader, that provides files for `ts-loader`, populate `data['ts-loader-files']`.

A simple example of a loader called "my-ts-html-loader", that generates typings for `.html` files:
...
This loader can then be used to supply typings for html files:

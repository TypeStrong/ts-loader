...
function loader(this: interfaces.Webpack, contents: string) {
    ...
    if (options.usePreviousLoaderGeneratedFiles) {
    ...
    if (options.usePreviousLoaderGeneratedFiles) {
        ...
        removeFileDependencies(this, filePath => generatedFiles[filePath] !== undefined);
    }
...
function getLoaderOptions(loader: interfaces.Webpack) {
    ...
    const options = Object.assign({}, {
        ...
        appendTsSuffixTo: [],
        entryFileIsJs: false,
        usePreviousLoaderGeneratedFiles: false,
 ...
 */
function removeFileDependencies(loader: interfaces.Webpack, exclude: (filePath: string) => boolean): void {
...
function getEmit(
    ...
    removeFileDependencies(loader, filePath => filePath === loader.resourcePath);

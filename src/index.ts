...
function loader(this: interfaces.Webpack, contents: string) {
    ...
    if (options.usePreviousLoaderGeneratedFiles) {
        ...
        removeGeneratedFileDependencies(this, generatedFiles);
    }
 ...
 * Remove dependencies on files generated by previous loaders in the same chain.
 */
function removeGeneratedFileDependencies(loader: interfaces.Webpack, generatedFiles: { [filePath: string]: string }): void {
    const dependencies = loader.getDependencies()
        .filter(f => generatedFiles[f] === undefined);

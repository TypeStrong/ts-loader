...
- [Introduce `entryFileIsJs` loader option which allows having an entry file which is js.`](https://github.com/TypeStrong/ts-loader/pull/399) - thanks @Wykks and @pqr.  
